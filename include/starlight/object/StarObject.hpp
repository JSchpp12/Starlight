  ...
  protected:
    class InstanceInfo
    {
      public:
        ...
        StarEntity &getInstance(const size_t &index)
        {
        ...
        const StarEntity &getInstance(const size_t &index) const
        {
            assert(index < m_instances.size());
            return m_instances[index];
        }
      ...
      private:
        std::vector<StarEntity> m_instances;
