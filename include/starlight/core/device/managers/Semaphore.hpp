...
class Semaphore : public ManagerEventBusTies<SemaphoreRecord, SemaphoreRequest, 2000>
{
  public:
    Semaphore()
        : ManagerEventBusTies<SemaphoreRecord, SemaphoreRequest, 2000>(common::special_types::SemaphoreTypeName,
