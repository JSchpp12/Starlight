...
void star::StarObject::initSharedResources(core::device::DeviceContext& device, vk::Extent2D swapChainExtent, int numSwapChainImages, 
...
void star::StarObject::cleanupRender(core::device::DeviceContext& device)
{
...
std::unique_ptr<star::StarPipeline> star::StarObject::buildPipeline(core::device::DeviceContext& device, vk::Extent2D swapChainExtent, 
...
std::vector<std::shared_ptr<star::StarDescriptorSetLayout>> star::StarObject::getDescriptorSetLayouts(core::device::DeviceContext& device)
{
