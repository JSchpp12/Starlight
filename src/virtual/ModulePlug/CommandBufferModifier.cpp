...
//     CommandBufferModifier::getOverrideBufferSubmissionCallback()
// {
//     return std::nullopt;
// }
...
//         std::function<void(vk::CommandBuffer &, const int &)>(
//             std::bind(&CommandBufferModifier::recordCommandBuffer, this, std::placeholders::_1, std::placeholders::_2)),
//         std::function<void(Handle)>(std::bind(&CommandBufferModifier::setBufferHandle, this, std::placeholders::_1)),
//         this->getCommandBufferOrder(), this->getCommandBufferOrderIndex(), this->getCommandBufferType(),
//         this->getWaitStages(), this->getWillBeSubmittedEachFrame(), this->getWillBeRecordedOnce(),
//         this->getBeforeBufferSubmissionCallback(), this->getOverrideBufferSubmissionCallback());
// }
