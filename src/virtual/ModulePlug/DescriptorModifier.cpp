...
void star::DescriptorModifier::submitToManager()
{
	...
	auto createCallback = std::function<void(core::DeviceContext&, const int&)>(std::bind(&DescriptorModifier::createDescriptors, this, std::placeholders::_1, std::placeholders::_2));
