...
star::SharedCompressedTexture::SharedCompressedTexture(const std::string& pathToFile, const vk::PhysicalDevice& physicalDevice)
: pathToFile(pathToFile) {
    ...
    this->selectedTranscodeTargetFormat = SelectTranscodeFormat(availableFormats, availableFormatNames); 
}
...
void star::SharedCompressedTexture::GetSupportedCompressedTextureFormats(const vk::PhysicalDevice& physicalDevice, std::vector<ktx_transcode_fmt_e>& availableFormats, std::vector<std::string>& availableFormatNames){
...
bool star::SharedCompressedTexture::IsFormatSupported(const vk::PhysicalDevice& physicalDevice, const vk::Format& format){
...
ktx_transcode_fmt_e star::SharedCompressedTexture::SelectTranscodeFormat(const std::vector<ktx_transcode_fmt_e>& availableFormats, const std::vector<std::string>& availableFormatNames){
...
void star::SharedCompressedTexture::loadKTX(){
    ...
    KTX_error_code result = ktxTexture2_CreateFromNamedFile(pathToFile.c_str(), KTX_TEXTURE_CREATE_LOAD_IMAGE_DATA_BIT, &this->resource); 
