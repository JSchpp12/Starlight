...
std::unique_ptr<star::StarBuffer> star::TransferRequest::LightInfo::createStagingBuffer(
...
std::unique_ptr<star::StarBuffer> star::TransferRequest::LightInfo::createFinal(
