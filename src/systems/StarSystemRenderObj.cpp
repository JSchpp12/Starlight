...
StarSystemRenderObject::~StarSystemRenderObject() {
	if (this->ownerOfSetLayout)
		this->starDevice.getDevice().destroyPipelineLayout(this->pipelineLayout);
}

void StarSystemRenderObject::registerShader(vk::ShaderStageFlagBits stage, StarShader& newShader, Handle newShaderHandle) {
...
Handle StarSystemRenderObject::getBaseShader(vk::ShaderStageFlags stage) {
	if (stage & vk::ShaderStageFlagBits::eVertex) {
...
void StarSystemRenderObject::setPipelineLayout(vk::PipelineLayout newPipelineLayout) {
	this->ownerOfSetLayout = false;
	this->pipelineLayout = newPipelineLayout;
}

size_t StarSystemRenderObject::getNumRenderObjects()
{
...
void StarSystemRenderObject::bind(vk::CommandBuffer& commandBuffer) {
	this->starPipeline->bind(commandBuffer);
}

void StarSystemRenderObject::updateBuffers(uint32_t currentImage) {
...
void StarSystemRenderObject::render(vk::CommandBuffer& commandBuffer, int swapChainImageIndex) {
...
void StarSystemRenderObject::createVertexBuffer() {
...
void StarSystemRenderObject::createRenderBuffers() {
...
void StarSystemRenderObject::createDescriptorPool() {
...
void StarSystemRenderObject::createDescriptors() {
...
void StarSystemRenderObject::createPipelineLayout(std::vector<vk::DescriptorSetLayout> globalDescriptorSets) {
...
void StarSystemRenderObject::createPipeline() {
	/* Scissor */
