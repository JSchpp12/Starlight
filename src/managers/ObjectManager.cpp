...
//
//namespace star {
//	void ObjectManager::loadObject(const std::string& pathToFile, std::vector<Vertex>* vertexList, std::vector<uint32_t>* indiciesList) {
...
//
//		//get base directory
//		auto baseDir = FileHelpers::GetBaseFileDirectory(pathToFile);
//
...
//	}
//
//	Handle ObjectManager::createAppropriateHandle() {
//		Handle newHandle;
//		newHandle.type = Handle_Type::object;
//		return newHandle;
//	}
//}