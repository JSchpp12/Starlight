...
StarBuffer::StarBuffer(VmaAllocator &allocator, const uint32_t &instanceCount, const vk::DeviceSize &instanceSize,
    ...
    : allocator(allocator), instanceCount(instanceCount), instanceSize(instanceSize),
...
void StarBuffer::CreateBuffer(VmaAllocator &allocator, const vk::DeviceSize &size, const vk::BufferUsageFlags &usage,
...
void StarBuffer::CreateBuffer(VmaAllocator &allocator, const VmaAllocationCreateInfo &allocCreateInfo,
...
StarBuffer::Builder::Builder(VmaAllocator &allocator) : allocator(allocator)
{
}

StarBuffer::Builder &StarBuffer::Builder::setAllocationCreateInfo(const VmaAllocationCreateInfo &nAllocInfo,
                                                                  const vk::BufferCreateInfo &nBufferInfo,
...
std::unique_ptr<StarBuffer> StarBuffer::Builder::build()
{
    ...
    return std::unique_ptr<StarBuffer>(new StarBuffer(this->allocator, this->instanceCount, this->instanceSize,
                                                      this->minOffsetAlignment, this->allocInfo, this->buffInfo,
                                                      this->allocName));
}
} // namespace star