...
void StarBuffers::Buffer::CreateBuffer(VmaAllocator &allocator, const vk::DeviceSize &size, const vk::BufferUsageFlags &usage, const VmaMemoryUsage &memoryUsage, const VmaAllocationCreateFlags &flags, vk::Buffer &buffer, VmaAllocation &memory, VmaAllocationInfo &allocationInfo, const std::string &allocationName)
{
...
void StarBuffers::Buffer::CreateBuffer(VmaAllocator &allocator, const VmaAllocationCreateInfo &allocCreateInfo, const vk::BufferCreateInfo &bufferInfo, const std::string &allocationName, vk::Buffer &buffer, VmaAllocation &memory, VmaAllocationInfo &allocationInfo)
{	
...
StarBuffers::Buffer::Builder::Builder(VmaAllocator &allocator)
: allocator(allocator)
{
}

StarBuffers::Buffer::Builder &StarBuffers::Buffer::Builder::setAllocationCreateInfo(const VmaAllocationCreateInfo &nAllocInfo, const vk::BufferCreateInfo &nBufferInfo, const std::string &nAllocName)
{
...
StarBuffers::Buffer::Builder &StarBuffers::Buffer::Builder::setMinOffsetAlignment(const vk::DeviceSize &nMinOffsetAlignment)
{
...
std::unique_ptr<StarBuffers::Buffer> StarBuffers::Buffer::Builder::build()
{
	...
	return std::unique_ptr<StarBuffers::Buffer>(new StarBuffers::Buffer(
		this->allocator, 
		this->instanceCount,
		this->instanceSize,
